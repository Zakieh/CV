...
% personal data
\name{\large Zakieh S.}{\large Hshemifar}
%\title{Resumé title}                               % optional, remove / comment the line if not wanted
\address{University at Buffalo, State University of New York}{}{}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
\vspace{-25pt}
\section{Interests}
\cvitem{}{Simultaneous Localization and Mapping, Perception and Manipulation, Multi-Robots Applications}
\section{Technical Skills}
\cvitem{OS}{Linux, Windows, ROS (Robotic Operating System)}
\cvitem{Programming Languages}{C++ (proficient), Matlab, Python, PHP, Java, HTML, C, C\#}
\cvitem{Software}{OPNET, Visual Studio, SQL Server, Latex, Adobe Flash}
...
\cventry{2014--Present}{}{Research Assistant, University at Buffalo}{Dr. Karthik Dantu}{}{
\textbf{Reasoning about Object Permanence in Mapping (Current work):} 
\begin{itemize}
\item Assign permanence probabilities to sensed elements within environment
\item Employ estimated permanence probabilities for weighing feature correspondences %better handling of feature correspondences
\item Increase the accuracy of loop closures in SLAM for dynamic environments
...
\end{itemize} 
\textbf{Wi-Fi Sensing Fusion for more Accurate Mapping and Localization (SLAM):} 
\begin{itemize}
\item Implemented a general approach for Wi-Fi sensing fusion into any visual SLAM algorithm
\item Incorporated Wi-Fi sensing into three well-known visual SLAM algorithms including ORB-SLAM, RTAB-Map and RGBD-SLAM%better handling of feature correspondences
\item Increased the localization/mapping accuracy of augmented algorithms
\item Decreased the computation time of loop closure detections
...
\cventry{2016}{Distributed Mapping of a Tunnel with Limited Communication}{Internship, Near Earth Autonomy}{Bradley Hamner}{}{
\begin{itemize}
...
\cventry{2012--2013}{Compressive Sensing Application for Failure Detection in Complex Networks}{Research Assistant, Sharif University of Technology}{Prof. Hamidreza R. Rabiee}{}{\begin{itemize}
...
\cventry{2009--2011}{Group Modeling and Representation in Learning Management Systems}{Research Assistant, Tehran University}{Dr. Fattaneh Taghiyare}{}{
\begin{itemize}
\item Designed an informative representation for showing learning progress of student groups
\item Implemented the Group Modeling plug-in in Moodle; an open source learning platform
%\item Applied covariance intersection for merging received information for the same landmark
%\item Implemented distributed mapping for two UAVs only sharing landmarks information  
\end{itemize}}%Worked on an informative representation of student groups in Learning Management Systems. using php which could provide a measurement and graphical model of learning progress}
...
\cvitem{2016}{Awarded scholarship for Grace Hopper Celebration attendance from ACM (Association for Computing Machinery)}
\cvitem{2014}{Awarded Dean's Fellowship in University at Buffalo}
\cvitem{2011}{Ranked $3^{rd}$ among more than 10000 applicants in nationwide university entrance exam for M.Sc. graduate students}
\cvitem{2010}{Ranked $2^{nd}$ among the students of Information Technology at the Department of Electrical and Computer Engineering, University of Tehran}
\cvitem{2005}{Ranked $188^{th}$ among more than 400000 applicants in the nationwide university entrance exam for undergraduate students}
\cvitem{2002}{Awarded in the first stage of National Mathematics Olympiad contest}
...
\cventry{2013}{C++ Basic and Advanced Programming}{Tutor}{Tehran, Iran}{}{}%
